...
beforeEach(function (): void {
    ...
    $paymentIntentMock->shouldReceive('create')->andReturn((object)[
    ...
    $stripeClientMock->paymentIntents = $paymentIntentMock;

    $this->provider = new StripePaymentProvider($stripeClientMock);
});

it('initiates and then charges a payment via the Stripe provider and records events', function (string $externalId): void {
